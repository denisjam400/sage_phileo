...
const Intro = () => {
    ...
    return (
        <div className="w-full h-max lg:h-[85vh] mb-8 md:mb-16 lg:mb-0 lg:pt-14 flex flex-col-reverse lg:flex-row justify-end items-start lg:items-center gap-8 lg:gap-16">
            ...
            <div className="h-[40vh] sm:h-[47vh] lg:h-[80%] w-full lg:w-[50%] flex flex-col gap-1 md:gap-3">
                ...
                <p className={`${styles.heroSubText} capitalize md:mt-2 text-white/90`}>
                    an educator with a vision
                </p>
                <p className={`capitalize text-white/90 lg:text-[20px] sm:text-[15px] text-[13px] lg:leading-[30px]`}>
                ...
                <button className="border-[1px] border-white hover:border-none hover:bg-main_color hover:text-white mt-3 pl-4 capitalize w-[50%] sm:w-[30%] md:w-[25%] h-[15%] sm:h-[12%] lg:h-[9%] rounded-full flex justify-between items-center group">
                    about me
                    <span className="bg-main_color group-hover:bg-white group-hover:text-main_color w-[30%] md:w-[23%] h-full rounded-full flex justify-center items-center text-lg">
                        <FaArrowRight />
                    </span>
                </button>
            </div>
