...
const Navbar = () => {
    ...
    return (
        <div className="fixed top-0 left-0 w-full h-[80px] flex justify-center items-center z-50">
            <nav className="backdrop-blur-md bg-gray-200/50 text-white px-3 lg:px-5 w-[85%] md:w-[80%] h-[70%] rounded-2xl flex justify-between items-center z-40">
                <h2>Sage Phileo</h2>
                ...
                {navBar && <nav className="absolute top-16 left-2 sm:left-5 border-[1px] w-[280px] sm:w-[70%] h-[43vh] px-5 py-3 flex lg:hidden rounded-3xl shadow-lg shadow-main_color bg-black border-white/75 z-40">
